...
class PermohonanSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permohonan = Permohonan_Cuti::create([
            'user_id' => '2',
            'alasan_cuti' => 'Berobat di RS',
            'tgl_mulai' => '2022-10-10',
            'tgl_akhir' => '2022-10-10',
            'tgl_memohon' => '2022-09-14',
            'durasi_cuti' => '4',
            'status' => 'Diterima',
            'created_at' => date('Y-m-d H:i:s'),
        ...
        $permohonan = Permohonan_Cuti::create([
            ...
            'tgl_mulai' => '2022-10-11',
            'tgl_akhir' => '2022-10-12',
            'tgl_memohon' => '2022-09-14',
            'durasi_cuti' => '2',
        ...
        $permohonan = Permohonan_Cuti::create([
            'user_id' => '10',
            'alasan_cuti' => 'Jaga orang tua sakit',
