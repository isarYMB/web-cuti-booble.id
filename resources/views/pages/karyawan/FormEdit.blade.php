                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <select name="divisi" class="custom-select">
                                                @foreach ($listDivisi as $row)
                                                    <option value="{{ $row->nama_divisi }}"
                                                        {{ $k->divisi == $row->nama_divisi ? 'selected' : '' }}>
                                                        {{ $row->nama_divisi }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select name="jabatan" class="custom-select">
                                                @foreach ($listJabatan as $row)
                                                    <option value="{{ $row->nama_jabatan }}"
                                                        {{ $k->jabatan == $row->nama_jabatan ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $k->no_telpon }}"
                                                class="@error('no_telpon') is-invalid @enderror form-control"
                                                name="no_telpon">
                                            @error('no_telpon')
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="jumlah_cuti" value="{{ $k->jumlah_cuti }}">
                                            @error('jumlah_cuti')
                                                <span class="invalid-feedback" role="alert">
