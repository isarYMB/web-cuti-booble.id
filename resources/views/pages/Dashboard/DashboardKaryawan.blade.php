                    ...
                    <ul class="sidebar-menu">
                        <li>
                            <a class="nav-link" href="#">
                                <img class="logo-name" src="{{ 'https://i.ibb.co/Y0n3q6S/Logo2-2.png' }}">
                            </a>
                        </li>
                    </ul>
                                ...
                                <table class="table table-striped">
                                    <tr>
                                        <th class="ml-4 mt-3 text-left  ">
                                            @if ($sisa_cuti != 0)
                                                <div class="ml-4 badge text-wrap diterima">Sisa Cuti:
                                                    {{ $sisa_cuti }}</div>
                                            @else
                                                <div class="ml-4 badge text-wrap ditolak">Sisa Cuti:
                                                    {{ $sisa_cuti }}</div>
                                            @endif

                                        </th>
                                        <th class="ml-4 mt-3 text-right  ">
                                            <button class="btn btn-warning mr-4" data-toggle="modal"
                                                data-target="#exampleModal"><i class="fa fa-plus"></i> Tambah</button>
                                        </th>
                                    </tr>
                                </table>
                                    ...
                                    <div class="table-responsive table-invoice">
                                        <table class="table table-striped">
                                            ...
                                            @if ($permohonan->isEmpty())
                                                <tr>
                                                    <td colspan="8" class="p-0 text-center">Anda Belum Mengajukan
                                                        Cuti</td>
                                                </tr>
                                            @else
                                                @foreach ($permohonan as $i => $p)
                                                    <tr>
                                                        ...
                                                        <td class="align-middle text-center">{{ $p->durasi_cuti }}
                                                        </td>
                            ...
                            <div class="modal-body">
                                <form class="" action="{{ route('permohonan.insert') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tgl_mulai" required
                                            class="form-control datepicker">
                                    </div>
                                    <div class="form-group">
                                        <label>Tanggal Berahir Cuti</label>
                                        <input type="text" name="tgl_akhir" required
                                            class="form-control datepicker">
                                    </div>
                                    <div id='loader'></div>
                        ...
                        isInvalidDate: function(date) {
                            var dateRanges = [
                                @foreach ($getRagneTanggal as $g)
                                    {
                                        'start': moment('{{ $g->tgl_mulai }}'),
                                        'end': moment('{{ $g->tgl_akhir }}')
                                    },
