...
<head>
    <title>Surat Cuti Booble.id</title>
    <meta charset="utf-8">
    <style>
        #judul {
            text-align: center;
    ...
    <div id=halaman>
        ...
        @foreach ($dataSurat as $i => $p)
            ...
            <table>
                ...
                @if ($ifOneDayMulai == $ifOneDayAkhir)
                    <tr>
                ...
                @elseif ($bulanLaporan_awal == $bulanLaporan_akhir)
                    <tr>
                        <td style="width: 150px;">Hari/Tanggal</td>
                        <td style="width: 10px;">:</td>
                        <td>
                            {{ $hariMulai }} sd {{ $hariAkhir }} / {{ $hari_mulai }} - {{ $hari_akhir }}
                            {{ $bulanLaporan_akhir }}
                        </td>
                    </tr>
                @else
                    <tr>
                        ...
                        <td style="width: 10px;">:</td>
                        <td>
                            {{ $hariMulai }} sd {{ $hariAkhir }} / {{ $hari_mulai }}
                            {{ $bulanLaporan_awalBulan }} - {{ $hari_akhir }}
                            {{ $bulanLaporan_akhir }}
                        </td>
                    </tr>
                @endif
            ...
            <table class="border" style="width: 170mm; ">
                <tr class="border">
                    <td class="border" style="width: 32%;text-align: center;font-weight: bold; padding:5px">
                        Diajukan,
                    </td>
                    <td class="border" style="width: 32%;text-align: center;font-weight: bold;padding:5px">Disetujui
                        Oleh,</td>
                    <td class="border" style="width: 32%;text-align: center;font-weight: bold;padding:5px">
                        Mengetahui,
                    </td>
                ...
                <tr class="border">
                    ...
                    <td class="border" style="width: 32%;text-align: center; padding-top: 100px;">
                        <p style="text-decoration: underline;font-weight: bold;">{{ $getHRD }}</p>
                        <p style="margin-top:-10px;">HRD</p>
                    </td>
                </tr>
            </table>
        @endforeach
