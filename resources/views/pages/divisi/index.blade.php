...
@section('content')
    ...
    <div class="main-content">
                    ...
                    <div class="card">
                        <div class="d-flex justify-content-end">
                            <div class="card-footer text-right">
                                <tr>
                                    <th><button data-backdrop="true" data-toggle="modal" href="#"
                                            data-target="#exampleModal1" class="btn btn-warning mr-1" type="submit"><i
                                                class="fa fa-plus"></i> Divisi</button>
                                    </th>
                                    <th><button data-backdrop="true" data-toggle="modal" href="#"
                                            data-target="#exampleModal2" class="btn btn-warning mr-1" type="submit"><i
                                                class="fa fa-plus"></i> Jabatan</button>
                                    </th>
                                </tr>
                            ...
                            <div class="table-responsive table-invoice">
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                                                ...
                                                {{-- <a class="hoverHapus"
                                                    href="{{ route('jabatan.destroy', ['id' => $k->id]) }}">
                                                ...
                                                <a class="hoverHapus" data-id="{{ $k->id }}"
                                                    data-target="#hapusJabatan" data-toggle="modal" data-backdrop="true"
                                                    href="#">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <!-- modal hapus -->
        <div class="modal fade" id="hapusJabatan" tabindex="-1" role="dialog" aria-labelledby="formModal"
            aria-hidden="true">
            <div class="modal-dialog-centered modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="formModal">Anda Yakin Menghapus Jabatan Ini?
                        </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    ...
                    <div class="modal-body">
                        <form class="" action="{{ route('jabatan.destroy') }}" method="get">
                            @csrf
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-block btn-danger m-t-15 waves-effect">Hapus</button>
                            </div>
                            <div class="form-group">
                                <input type="hidden" id="hapusJabatanModal" name="custId">
                            </div>
                        </form>
                    </div>
                </div>
